...
const PRODUCTS = {
  'moving': [
    { id: 'moving-starter', name: 'Moving Leads Starter', price: 2900, interval: 'month', leads: 10 },
    { id: 'moving-pro', name: 'Moving Leads Pro', price: 7900, interval: 'month', leads: 40 },
    { id: 'moving-enterprise', name: 'Moving Leads Enterprise', price: 14900, interval: 'month', leads: 100 }
  ],
  'probate': [
    { id: 'prob-essential', name: 'Probate Leads Essentials', price: 9700, interval: 'month', leads: 15 },
    { id: 'prob-pro', name: 'Probate Leads Professional', price: 19700, interval: 'month', leads: 60 },
    { id: 'prob-enterprise', name: 'Probate Leads Enterprise', price: 34700, interval: 'month', leads: 200 }
  ],
  'newbusiness': [
  ...
  'planning': [
    { id: 'plan-essential', name: 'Planning Permission Essentials', price: 7900, interval: 'month', leads: 25 },
    { id: 'plan-pro', name: 'Planning Permission Pro', price: 14700, interval: 'month', leads: 60 },
    { id: 'plan-enterprise', name: 'Planning Permission Enterprise', price: 29700, interval: 'month', leads: 200 }
  ],
  'tenders': [
    { id: 'tend-essential', name: 'Public Tenders Essential', price: 7900, interval: 'month', leads: 15 },
    { id: 'tend-pro', name: 'Public Tenders Pro', price: 14700, interval: 'month', leads: 40 },
    { id: 'tend-enterprise', name: 'Public Tenders Enterprise', price: 29700, interval: 'month', leads: 100 }
  ]
};
